...
def RPCHelp_cpp(w):
    ...
    for mode in modes:
        ...
        if mode != 'EModeType::MODE_CONSOLE':
            ...
            # options is not empty, output options. It's metabasenet-cli -help
...
def generate_protocol_h():
    with open(protocol_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef METABASENET_RPC_AUTO_PROTOCOL_H
#define METABASENET_RPC_AUTO_PROTOCOL_H
...
def generate_config_h():
    with open(config_h, 'w') as w:
        ...
        # file top
        w.write('''
#ifndef METABASENET_MODE_AUTO_CONFIG_H
#define METABASENET_MODE_AUTO_CONFIG_H
