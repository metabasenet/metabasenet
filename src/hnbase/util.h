...
#define STD_DEBUG(Mod, Info) hnbase::StdDebug(Mod, hnbase::PulsFileLine(__FILE__, __LINE__, Info).c_str())

#define STD_LOG(Mod, Info) hnbase::StdLog(Mod, hnbase::PulsFileLine(__FILE__, __LINE__, Info).c_str())

#define STD_WARN(Mod, Info) hnbase::StdWarn(Mod, hnbase::PulsFileLine(__FILE__, __LINE__, Info).c_str())

#define STD_Eerror(Mod, Info) hnbase::StdError(Mod, hnbase::PulsFileLine(__FILE__, __LINE__, Info).c_str())
