...
public:
    ...
    bool BuildEnrollTx(CTransaction& tx, const int nBlockHeight, const int64 nTime, const uint64 nTxNonce,
                       const uint256& hashFork, const std::vector<unsigned char>& vchData);
