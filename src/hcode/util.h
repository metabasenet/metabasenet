...
#define STD_DEBUG(Mod, Info) hcode::StdDebug(Mod, hcode::PulsFileLine(__FILE__, __LINE__, Info).c_str())

#define STD_LOG(Mod, Info) hcode::StdLog(Mod, hcode::PulsFileLine(__FILE__, __LINE__, Info).c_str())

#define STD_WARN(Mod, Info) hcode::StdWarn(Mod, hcode::PulsFileLine(__FILE__, __LINE__, Info).c_str())

#define STD_Eerror(Mod, Info) hcode::StdError(Mod, hcode::PulsFileLine(__FILE__, __LINE__, Info).c_str())
