...
public:
    ...
    void Deinitialize();
    bool RemoveAll();
    bool AddBlockState(const uint256& hashPrevRoot, uint256& hashBlockRoot, const std::map<CDestination, CDestState>& mapBlockState);
    bool CreateCacheStateTrie(const uint256& hashPrevRoot, uint256& hashBlockRoot, const std::map<CDestination, CDestState>& mapBlockState);
...
public:
    ...
    static bool CreateStaticStateRoot(const std::map<CDestination, CDestState>& mapBlockState, uint256& hashStateRoot);
