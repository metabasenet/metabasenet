...
#ifndef METABASENET_DATASTAT_H
#define METABASENET_DATASTAT_H
...
#define STAT_MAX_ITEM_COUNT (3600 * 24 / BLOCK_TARGET_SPACING)
...
public:
    ...
    void AddTxSynStatData(const uint64 nTxCount, const bool fRecv);
    void TimerStatData(uint32 nTimeValue);
...
public:
    ...
    bool AddP2pSynTxSynStatData(const uint256& hashFork, const uint64 nTxCount, const bool fRecv) override;
