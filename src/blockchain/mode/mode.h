...
#ifndef METABASENET_MODE_MODE_H
#define METABASENET_MODE_MODE_H
        ...
        static std::map<EModeType, std::vector<EModuleType>> mapping = {
            { EModeType::MODE_SERVER,
              { EModuleType::LOCK,
                ...
                EModuleType::BLOCKCHANNEL,
                EModuleType::CERTTXCHANNEL,
                EModuleType::USERTXCHANNEL,
                EModuleType::BLOCKVOTECHANNEL,
                EModuleType::BLOCKCROSSPROVE,
                ...
                EModuleType::WSSERVICE,
                EModuleType::BLOCKFILTER } },
