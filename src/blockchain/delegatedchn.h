...
#ifndef METABASENET_DELEGATEDCHN_H
#define METABASENET_DELEGATEDCHN_H
...
class CDelegatedChannelPeer : public mtbase::CDataPeer<CDelegatedDataIdent>
{
public:
...
protected:
    ...
    void DispatchMisbehaveEvent(uint64 nNonce, mtbase::CEndpointManager::CloseReason reason);
...
protected:
    ...
    mtbase::CDataScheduler<CDelegatedDataIdent> schedPeer;
...
#endif //METABASENET_DELEGATEDCHN_H
