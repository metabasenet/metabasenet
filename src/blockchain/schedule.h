...
#ifndef METABASENET_SCHEDULE_H
#define METABASENET_SCHEDULE_H
...
public:
    ...
    uint256 GetNextTx(const CDestination& destFrom, const uint64 nNextTxNonce);
