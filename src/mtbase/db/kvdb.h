...
#ifndef MTBASE_KVDB_H
#define MTBASE_KVDB_H
...
protected:
    ...
    bool Read(CBufStream& ssKey, CBufStream& ssValue)
    {
        try
        {
            boost::recursive_mutex::scoped_lock lock(mtx);
    ...
    bool Write(CBufStream& ssKey, CBufStream& ssValue, bool fOverwrite = true)
    {
        try
        {
            boost::recursive_mutex::scoped_lock lock(mtx);
